...
def canteraSim(cbDict):

    global fuel_species,CASENAME,p,Lx,chemMech,stoich_O2,T_fuel,X_fuel
    global T_ox,X_ox,Z,phi,phi_tab,sL,transModel,nSpeMech,nVarCant,solFln
